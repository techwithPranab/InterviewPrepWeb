  ...
  const fetchSession = async () => {
    try {
      ...
      if (response.success) {
        ...
        throw new Error(response.message || 'Failed to load interview report');
      }
  ...
  const handleExportPDF = () => {
    ...
    try {
      ...
      const pdfData = {
        ...
        feedback: session.overallEvaluation?.summary || 'No feedback available',
        questions: session.questions,
      };
      generateInterviewPDF(pdfData, userName);
    } catch (err) {
